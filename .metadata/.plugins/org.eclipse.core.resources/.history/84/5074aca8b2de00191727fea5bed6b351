package com.andrealef.pacientemilmongo.domain;
...
@Document(collection = "pacientemil")
public class Pacientemil implements Serializable {
	...
	public Pacientemil(String id, int prontuario, String paciente, String sexo, String arma, String patente, String TS,
	...
	public boolean equals(Object obj) {
		...
		Pacientemil other = (Pacientemil)obj;
		  if(id==null) {
			  if(other.id!=null)
				  return false;
